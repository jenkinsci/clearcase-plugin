...
public interface ClearTool {
	 ...
	 * @param viewName the name of the view
	 * @param branch the name of the branch to get history events for; if null then history events for
	 * all branches are listed
	 * @return the event records
	 */
	List<ClearCaseChangeLogEntry> lshistory(ClearToolLauncher launcher,Date lastBuildDate, String viewName, String branch) throws IOException, InterruptedException;
	 ...
	 */
	List<String> lsview(ClearToolLauncher launcher, boolean onlyActiveDynamicViews) throws IOException, InterruptedException;
